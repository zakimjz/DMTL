 ...
 */
#ifndef _ISET_CAN_CODE_
#define _ISET_CAN_CODE_
...
class canonical_code<ISET_PROP, vertex_t, edge_t, ALLOC > 
{
 public:
...
int canonical_code<ISET_PROP, v, e, ALLOC>::id_generator = -1;

template<class PP, typename v, typename e, template <typename> class ALLOC >
int canonical_code<ISET_PROP, v, e, ALLOC>::init_counter = 1;

template<class PP, typename v, typename e, template <typename> class ALLOC >
map<v, int> canonical_code<ISET_PROP, v, e, ALLOC >::len1_pat_map;
