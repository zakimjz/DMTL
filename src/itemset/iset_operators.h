 ...
 */
#ifndef _ISET_OPERATORS_H_
#define _ISET_OPERATORS_H_
...
template<class PP, class MP, class PAT_ST, 
         template<typename, typename, typename, template <typename> class > class CC,
         template <typename> class ALLOC >
ostream& operator<< (ostream& ostr, const ISET_PATTERN* p) {
  typename ISET_PATTERN::CONST_IT it;
