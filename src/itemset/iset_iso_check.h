 ...
 */
#ifndef _ISET_ISO_CHECK_H_
#define _ISET_ISO_CHECK_H_
 ...
 */
template<typename PP, class MP, class PAT_ST, template<class, typename, typename, template <typename> class > class CAN_CODE, 
         template <typename> class ALLOC >
bool check_isomorphism(pattern<ISET_PROP, MP, PAT_ST, CAN_CODE, ALLOC>* const& cand_pat) { 
  // NOTE:
